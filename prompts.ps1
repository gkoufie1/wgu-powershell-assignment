...
Function Out-LogFiles {
    ...
    $logFiles | Out-File -Append $requiredFilesPath\DailyLog.txt
    
}

Function Get-DailyLog {
    Get-Content $PSScriptRoot\Requirements1\DailyLog.txt
}
...
Function List-AllFiles {
    ...
    $logFiles | Out-File $requiredFilesPath\C916contents.txt    
